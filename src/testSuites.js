...
export const testSuites = [
  {
    ...
    tests: [
      ...
      {
        deepEqual: false,
        description: 'typed array are deeply not equal',
        shallowEqual: false,
        value1: new Float64Array([1, 2, 3, 6]),
        value2: new Float64Array([1, 2, 3]),
      },
      {
        deepEqual: true,
        description: 'typed array are equal when strictly equal',
        shallowEqual: true,
        value1: typedArray,
        value2: typedArray,
      },
